...
public class HikariCpConfig {
    ...
    @Value("${DB_DAW_URL}")
    private String dbDawUrl;
    @Value("${DB_DAW_USER}")
    private String dbDawUser;
    @Value("${DB_DAW_PASS}")
    private String dbDawPass;
    @Value("${DB_DAW_DRIVER}")
    private String dbDawDriver;
    ...
    public HikariDataSource hikariDataSource() {
         ...
         */
        config.setJdbcUrl(dbDawUrl);
        config.setUsername(dbDawUser);
        config.setPassword(dbDawPass);
        config.setDriverClassName(dbDawDriver);
